    ...
    <div className="animate-fade-in">
      ...
      {step === 1 && (
        <div className="animate-fade-in">
          <div className="bg-white rounded-2xl border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.04)] p-6">
            ...
            <p className="text-sm text-gray-500 mb-5">지원 직무에 맞춰 이력서가 최적화됩니다.</p>
            <input
              value={targetRole}
      ...
      {step === 2 && (
        <div className="animate-fade-in">
          ...
          {generating && <div className="mt-4"><LoadingSpinner text="AI가 이력서를 작성하고 있습니다..." /></div>}
        </div>
      )}
